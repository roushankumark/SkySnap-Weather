...
const FooterNav = (props) => {
  ...
  const isDashboardActive = currentPath === "/weather" || currentPath === "/dashboard" || currentPath === "/weathermain" || currentPath === "/";
  const isSettingsActive = currentPath === "/settings";
  const isSupportActive = currentPath === "/support";

  const handleKeyPress = (e, targetPath) => {
  ...
  return (
    <div className="footer-nav">
      ...
      <div 
        ...
        onKeyDown={(e) => handleKeyPress(e, "/weather")}
        role="button"
        tabIndex="0"
      ...
      <div 
        ...
        onKeyDown={(e) => handleKeyPress(e, "/settings")}
        role="button"
        tabIndex="0"
        title="Settings"
      >
      ...
      <div 
        ...
        onKeyDown={(e) => handleKeyPress(e, "/support")}
        role="button"
        tabIndex="0"
        title="Support"
      >
